...
const navigation = [
  ...
  { name: "My Gigs", href: "/service-provider/dashboard/gigs", icon: Briefcase },
  { name: "Revenue", href: "/service-provider/dashboard/revenue", icon: DollarSign },
  { name: "Messages", href: "/service-provider/dashboard/messages", icon: MessageSquare },
  { name: "Profile", href: "/service-provider/dashboard/profile", icon: User },
          ...
          <div className="fixed inset-y-0 left-0 z-50 w-64 bg-card border-r border-border">
            <div className="flex items-center justify-between p-4 border-b border-border">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-lg font-bold text-foreground">Provider Panel</span>
              </Link>
