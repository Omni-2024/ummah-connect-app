...
export default function AdminSidebar() {
  ...
  return (
    <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-64 lg:flex-col">
      <Card className="flex grow flex-col overflow-y-auto border-r border-border rounded-none bg-[#337f7c]/20">
        <div className="flex items-center justify-between p-6 border-b border-[#337f7c]/50">
