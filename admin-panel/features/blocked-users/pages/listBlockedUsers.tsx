...
import { BlockedUserCard } from "@/features/blocked-users/cards/blockedUserCard";
...
import {useGeneralBlockedUsers, useGeneralUsers} from "@/lib/hooks/useGeneralUsers";
import {deleteUserFn, forceDeleteUserFn, unBlockUserFn} from "@/lib/endpoints/usersFns";
...
import UnblockDialog from "@/components/widget/unblockDialog";
...
const ListBlockedUsers: React.FC<ListUsersProps> = ({ search, clearSearch }) => {
  ...
  return (
    <>
      ...
      <UnblockDialog
          ...
          onRemove={() => {
            if (selectedUser) unblockUser(selectedUser);
          }}
          onClose={() => {
            setPopupType(null);
            setSelectedUser(null);
