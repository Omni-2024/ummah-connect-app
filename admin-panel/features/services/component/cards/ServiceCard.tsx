...
import { useCurrentUser } from "@/hooks/useUserInfo"; // ✅ import current user
...
const ServiceCard: React.FC<ServiceCardProps> = (props) => {
  ...
  // 🚫 Don't render services that belong to another provider
  if (currentUser && props.service.providerId !== currentUser.id) {
    return null;
  }
