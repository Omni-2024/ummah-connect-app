          ...
          {steps.map(({ stepId, title }) => {
            ...
            return (
              <div key={stepId} className="flex-1">
                <div
                  className={cn("h-2 flex-1 rounded-full bg-[#90EE90]", {
                    "bg-[#90EE90]": status === "todo",
                    "bg-[#009f6b]": status === "current",
                  })}
                />
...
const StepSeparator = () => {
  return <div className="mx-6 h-0.5 w-12 rounded-full bg-[#009f6b]" />;
};
