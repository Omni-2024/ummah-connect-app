    ...
    "inline-flex items-center gap-2 font-secondary justify-center whitespace-nowrap rounded-full text-sm transition-colors focus-visible:outline-none select-none ease-in focus-visible:ring-1 disabled:pointer-events-none cursor-pointer ring-primary-200",
    {
        variants: {
            variant: {
                ...
                secondary:
                    "bg-white text-primary-500 hover:bg-primary-50 hover:border-transparent disabled:text-dark-100 disabled:border-dark-100 border border-primary-500 active:text-primary-700 active:border-transparent active:bg-primary-100",
            ...
            size: {
                lg: "h-11 lg:h-10 px-9 text-[0.9rem]",
                md: "h-10 lg:h-9 px-6 text-sm font-medium",
                sm: "h-9 lg:h-8 px-5 text-xs font-medium",
                xs: "h-8 lg:h-7 px-4 text-xs ",
                icon: "h-9 w-9",
            },
        },
        defaultVariants: {
