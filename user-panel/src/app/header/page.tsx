  ...
  return (
    <header className="sticky h-20 top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm pt-1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile menu */}
        {mobileMenuOpen && (
          <div className="lg:hidden border-t border-slate-200 py-4 bg-white/95 backdrop-blur-md">
            {/* Mobile Search */}
            {isAuthenticated && (
            ...
            <div className="flex flex-col space-y-1 px-3">
              ...
              <button
                ...
                className="text-left px-3 py-3 text-base font-medium text-slate-700 hover:text-emerald-600 hover:bg-slate-50 rounded-lg transition-colors duration-200"
              >
                Explore Courses
              </button>
              ...
              {!isAuthenticated && (
                <>
                  <button
                    ...
                    className="text-left px-3 py-3 text-base font-medium text-slate-700 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-colors duration-200"
                  >
                    Sign In
                  </button>
                  <button
                    ...
                    className="mx-3 mt-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-4 py-3 rounded-lg hover:from-emerald-600 hover:to-teal-700 transition-all duration-200 text-center font-medium"
                  >
                    Join Now
                  </button>
                </>
